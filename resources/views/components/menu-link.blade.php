...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center mt-2 px-5 py-2 bg-blue-600 border border-transparent rounded-lg font-semibold text-md text-white tracking-widest shadow-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 focus:ring-offset-gray-900 active:bg-blue-700 disabled:opacity-50 transition duration-200 ease-in-out transform hover:scale-105'
